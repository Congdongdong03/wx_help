...
exports.distributePosts =
  exports.mapToFeedPost =
  exports.truncateText =
  exports.validatePostData =
  exports.handlePostError =
...
const mapToFeedPost = (item) => {
  ...
  return {
    ...
    mockImagePlaceholderHeight:
      constants_1.PRESET_PLACEHOLDER_HEIGHTS[
        Math.floor(
          Math.random() * constants_1.PRESET_PLACEHOLDER_HEIGHTS.length
        )
      ],
    mockImagePlaceholderColor:
      constants_1.PRESET_PLACEHOLDER_COLORS[
        Math.floor(Math.random() * constants_1.PRESET_PLACEHOLDER_COLORS.length)
      ],
    title: item.title,
    ...
    category: {
      id: item.category_id,
      name:
        ((_a = constants_1.CATEGORIES.find(
          (cat) => cat.id === item.category_id
        )) === null || _a === void 0
          ? void 0
          : _a.name) || "",
      color:
        ((_b = constants_1.CATEGORIES.find(
          (cat) => cat.id === item.category_id
        )) === null || _b === void 0
          ? void 0
          : _b.color) || "",
